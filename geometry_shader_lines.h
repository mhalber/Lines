...
typedef struct geom_shader_lines_uniform_locations
{
  GLuint mvp;
  GLuint viewport_size;
  GLuint aa_radius;
} geom_shader_lines_uniform_locations_t;

typedef struct geom_shader_lines_attrib_locations
{
  GLuint pos_width;
  GLuint col;
} geom_shader_lines_attrib_locations_t;
